    ...
    return(
        <div className="flex items-center justify-between md:justify-evenly">
            ...
            <div className="flex items-center justify-center w-[50vw] lg:w-[50%]">
                <textarea className={`bg-transparent text-[18px] text-redFont font-bold min-h-[150px] md:min-h-[100px] text-center w-[40vw] ${objective_text.length < 1 ? "border-solid border-2 border-black rounded-md" : ""}`}
