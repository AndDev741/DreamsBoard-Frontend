...
return(
        <div className="flex flex-col items-center justify-center">
            <input type='text'
            className={`bg-transparent text-center mt-5 mb-3 text-2xl font-bold text-redFont w-[90%] lg:w-[100%] ${reasonTitle.length < 1 ? "border-b-2 border-solid border-black" : ""}`}
            value={reasonTitle}
